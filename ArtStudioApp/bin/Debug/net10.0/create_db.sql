...
INSERT OR IGNORE INTO table_performers (nickname, first_name, last_name, registration_date)
...
INSERT OR IGNORE INTO table_personalfiles (performer_id, passport_series, passport_number, address)
...
INSERT OR IGNORE INTO table_projects (name, deadline)
VALUES ('Космическое шоу', '2025-12-01'),
       ('Рокет-фест', '2025-10-15'),
       ('Супергеройский баттл', '2025-11-30');

INSERT OR IGNORE INTO table_performerprojects (performer_id, project_id, role)
VALUES (1, 1, 'Ведущий'),
       (2, 1, 'Монтажёр'),
       (3, 1, 'Сценарист'),
       (4, 1, 'Оператор'),
